...
import { ref } from 'vue'
import RubiksCube2x2 from '../components/RubiksCube2x2.vue'

const cubeRef = ref<InstanceType<typeof RubiksCube2x2> | null>(null)
...
<template>
  <el-card class="page">
    <template #header>
      <span class="cube-title">2×2 魔方</span>
    </template>
    <div class="layout">
      <div class="main">
        <div class="toolbar">
        ...
        <RubiksCube2x2 ref="cubeRef" class="canvas-wrap" />
        <div class="controls">
          ...
          <div class="manual-body">
            ...
            <section>
              ...
              <p>
                ...
                <code>U</code> 与 <code>U'</code>（带撇表示逆）。按钮旁也标注了对应记号。
              </p>
            </section>
          </div>
        </el-card>
